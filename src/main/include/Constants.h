...
namespace DriveConstants {
    ...
    */
    ...
    constexpr int kFrontLeftEncoderChannel = 25; 
    constexpr int kFrontRightEncoderChannel = 26;
    constexpr int kRearLeftEncoderChannel = 27;
    constexpr int kRearRightEncoderChannel = 28;
