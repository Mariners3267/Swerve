...
namespace DriveConstants {
    ...
    */
    ...
    constexpr int kFrontLeftCanCoderCanId = 25;  //Absolute Encoders
    constexpr int kFrontRightCanCoderCanId = 26;
    constexpr int kRearLeftCanCoderCanId = 27;
    constexpr int kRearRightCanCoderCanId = 28;
